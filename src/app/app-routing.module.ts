...
const routes: Routes = [
  ...
  { path: 'reset', loadChildren: './signup/reset-password/reset-password.module#ResetPasswordPageModule' },
  ...
  { path: 'stores/new', loadChildren: './signup/shop-info/shop-info.module#ShopInfoPageModule' },
